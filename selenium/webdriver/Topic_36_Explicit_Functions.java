...
public class Topic_36_Explicit_Functions {
    ...
    @Test
    public void TC_01_() {
        // Wait cho element không hiện thị không còn trong HTML (trước đó có tồn tại)
        explicitWait.until(ExpectedConditions.stalenessOf(driver.findElement(By.cssSelector(""))));

        // Wait cho element không hiện thị (còn/ không còn trong HTML)
        explicitWait.until(ExpectedConditions.invisibilityOfElementLocated(By.cssSelector("")));

        // Wait cho element đưuojc hiện thị (phải có trong HTML/ có trên UI)
        explicitWait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("")));

        // Wait cho element được phép clickable (button/ link/ radio/ checkbox/...)
        ...
        // Wait cho 1 element có thuộc tính ở trong DOM bằng giá trị nào
        ...
        // Wait cho element đã được chọn thành công (Checkbox/ Radio/ Dropdown Items)
        ...
        // Wait cho 1 đoạn lệnh JS được thực thi không cho trả về bất kì Exception nào hết
        ...
        explicitWait.until(ExpectedConditions.numberOfElementsToBe(By.cssSelector("ol#selectable>li.vi-selected"),6));

        // Wait cho 1 list element bằng bao nhiêu item
        List<WebElement> allNumberSelected = explicitWait.until(ExpectedConditions.numberOfElementsToBe(By.cssSelector("ol#selectable>li.vi-selected"),6));
        Assert.assertEquals (allNumberSelected.size(), 6);

        explicitWait.until(ExpectedConditions.numberOfElementsToBeLessThan(By.cssSelector("ol#selectable>li.vi-selected"), 7));
        explicitWait.until(ExpectedConditions.numberOfElementsToBeMoreThan(By.cssSelector("ol#selectable>li.vi-selected"), 5));

        // Wait cho số lượng Windown/ Tab bằng bao nhiêu
        ...
        // Wait cho 1 element hay bị change/ refresh lại/ update
