...
public class Topic_39_Mix {
    ...
    @Test
    public void TC_03_Element_Not_Found_Only_Emplicit_By(){
        explicitWait = new WebDriverWait(driver, Duration.ofSeconds(10));

        driver.get("https://live.techpanda.org/index.php/customer/account/login/");

        By emailTextboxBy = By.cssSelector("inpunt#automationfc");
    ...
    @Test
    public void TC_03_Element_Not_Found_Only_Emplicit_WebElement(){
        ...
        System.out.println("Start =  " + getDateTimeNow());
        try {
            explicitWait.until(ExpectedConditions.visibilityOf(driver.findElement(By.cssSelector("input#automationfc"))));
        } catch (Exception e) {
            System.out.println("End =  " + getDateTimeNow());
            throw new RuntimeException(e);
        }
    ...
    @Test
    public void TC_04_Element_Not_Found_Only_Emplicit(){
